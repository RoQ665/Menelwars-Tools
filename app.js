...
function setupAdmin() {
  ...
  function pvpDamageFormula(attacker,defender,round,params,isCrit,isFirst) {
    ...
    // Poziom 1 potwierdza małą, ukrytą bazę +5 obrażeń. Za każdy zdobyty
    // poziom testujemy dodatkowo +1 do ATK i +1 do DEF, a nie +5 dmg/lvl.
    ...
    const attack=(attacker.primary.attack+earnedAttackerLevels)*(1+(condA.attackPct+dynamicPct)/100)+5;
    // Ukryty DEF za zdobyte poziomy traktujemy jak zwykłą obronę, więc
    // przebicie pancerza zmniejsza również tę część.
    const defenseBeforePen=defender.primary.defense+earnedDefenderLevels;
